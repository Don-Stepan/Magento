...
return [
    'backend' => [
        'frontName' => 'admin_cccc8h'
    ],
    'queue' => [
        'consumers_wait_for_messages' => 1
    ],
    'crypt' => [
        'key' => '2130996c3717df078d7229a728f0db84'
    ],
    'db' => [
        'table_prefix' => '',
        'connection' => [
    ...
    'install' => [
        'date' => 'Wed, 03 Feb 2021 16:41:27 +0000'
    ],
    'system' => [
        'default' => [
            'admin' => [
            ...
            'web' => [
                'unsecure' => [
                    'base_url' => 'http://localhost/magento/',
            ...
            'catalog' => [
                'search' => [
                    ...
                    'elasticsearch7_server_hostname' => 'localhost.magento',
